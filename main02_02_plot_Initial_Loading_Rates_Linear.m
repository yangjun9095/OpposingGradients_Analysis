function main02_02_plot_Initial_Loading_Rates_Linear
...
[fittedRate_r0,fittedRateSD_r0,fittedTon_r0] = Extract_Fields_MeanFits(Data_r0,'Linear');

[fittedRate_r1_female,fittedRateSD_r1_female,fittedTon_r1_female] = Extract_Fields_MeanFits(Data_r1_female,'Linear');
[fittedRate_r2_female,fittedRateSD_r2_female,fittedTon_r2_female] = Extract_Fields_MeanFits(Data_r2_female,'Linear');
[fittedRate_r3_female,fittedRateSD_r3_female,fittedTon_r3_female] = Extract_Fields_MeanFits(Data_r3_female,'Linear');

% [fittedRate_r1_male,fittedRateSD_r1_male,fittedTon_r1_male] = Extract_Fields_MeanFits(Data_r1_male,'Linear');
% [fittedRate_r2_male,fittedRateSD_r2_male,fittedTon_r2_male] = Extract_Fields_MeanFits(Data_r2_male,'Linear');
% [fittedRate_r3_male,fittedRateSD_r3_male,fittedTon_r3_male] = Extract_Fields_MeanFits(Data_r3_male,'Linear');
...
for i=1:length(Data_r1_female)
    errorbar(0:0.025:1,fittedRate_r1_female(:,NC,i),fittedRateSD_r1_female(:,NC,i))
end
...
for i=1:length(Data_r3_female)
    errorbar(0:0.025:1,fittedRate_r3_female(:,NC,i),fittedRateSD_r3_female(:,NC,i))
    %pause
end
...
save('E:\YangJoon\LivemRNA\Data\Dropbox\OpposingGradient\OpposingGradients_ProcessedData\AveragedInitialRate_LinearFit.mat',...
