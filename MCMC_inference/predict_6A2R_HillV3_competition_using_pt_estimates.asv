...
tempPath2 = 'S:\YangJoon\Dropbox\OpposingGradientsFigures\PipelineOutput\MCMC_HillV3\Competition\seq_MCMC_inference\pt_estimate';
...
for i=1:3
    ...
    Prediction(i,:) = model_6A2R_HillModel_V3_competition(params_6A2R, TF);
