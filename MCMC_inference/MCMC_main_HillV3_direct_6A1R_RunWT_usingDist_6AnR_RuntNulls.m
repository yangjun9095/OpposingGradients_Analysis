function MCMC_main_HillV3_direct_6A1R_RunWT_usingDist_6AnR_RuntNulls
%% Description
...
%     clf
    ...
    n_burn = 0.5*n_steps;
    m = [chain(n_burn+1:end,1), chain(n_burn+1:end,2), chain(n_burn+1:end,3), chain(n_burn+1:end,4), chain(n_burn+1:end,5), chain(n_burn+1:end,6)];
    corner = figure;
...
for index = 1:3
    ...
    errorbar(1:6, params_inferred, params_inferred_std,'o','LineWidth',2,'Color',ColorChoice(construct,:))
end
