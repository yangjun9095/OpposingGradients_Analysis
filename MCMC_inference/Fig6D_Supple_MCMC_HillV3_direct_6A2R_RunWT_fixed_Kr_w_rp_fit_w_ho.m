function Fig6D_Supple_MCMC_HillV3_direct_6A2R_RunWT_fixed_Kr_w_rp_fit_w_ho
%% Description
...
%         end
    ...
    model_mcmc = @(params) model_6A2R_HillModel_V3_direct_fixed_Kr_Bcd_RNAP_w_rp_params([1, params(1)], TF, params_fixed);
...
%     plot(APbins, output)
    ...
    %pause
    saveas(gcf,[FigPath,filesep,'raw_fits_null_WT_95%CI_w_ho_01xKr', constructNames{construct} ,'.tif']); 
    saveas(gcf,[FigPath,filesep,'raw_fits_null_WT_95%CI_w_ho_01xKr', constructNames{construct} ,'.pdf']); 
end
