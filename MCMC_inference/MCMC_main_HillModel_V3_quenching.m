...
for i=1:3
    ...
    corner = figure;
    names = {'K_{b}','K_{r}','\omega_{bp}', '\omega_{brp}','p','R_{max}'};
...
A = load([FigPath, filesep, 'MCMCResult_HillV3_quenching.mat'], 'MCMCResult')
MCMCResult = A.MCMCResult;
