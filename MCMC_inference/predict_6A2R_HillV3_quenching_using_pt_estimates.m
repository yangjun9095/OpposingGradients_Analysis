%% predict_6A2R_cases
function predict_6A2R_HillV3_quenching_using_pt_estimates
%% Description
...
tempPath2 = 'S:\YangJoon\Dropbox\OpposingGradientsFigures\PipelineOutput\MCMC_HillV3\Quenching\seq_MCMC_inference\pt_estimate';
...
for i=1:3
    ...
    Prediction(i,:) = model_6A2R_HillModel_V3_quenching(params_6A2R, TF);
