function MCMC_main_HillV3_compete_6A2R_RunWT_fixed_Kr_w_rp_With_Coop_V1
%% Description
...
FilePath = 'S:\YangJoon\Dropbox\OpposingGradientsFigures\PipelineOutput\MCMC_HillV3\Competition\seq_MCMC_inference\6A2R_fixed_Kr';
FigPath = 'S:\YangJoon\Dropbox\OpposingGradientsFigures\PipelineOutput\MCMC_HillV3\Competition\seq_MCMC_inference\6A2R_fixed_Kr';
...
tempPath2 = 'S:\YangJoon\Dropbox\OpposingGradientsFigures\PipelineOutput\MCMC_HillV3\Competition\seq_MCMC_inference\6A1R_fixed_Kr';
...
w_br1 = MCMC_6A1R_RuntWT.params_inferred(2); %[100]
w_br2 = MCMC_6A1R_RuntWT.params_inferred(3); %[001]
w_br3 = MCMC_6A1R_RuntWT.params_inferred(4); %[010]

% std
K_r_std = MCMC_6A1R_RuntWT.params_inferred_sigma(1);
w_br1_std = MCMC_6A1R_RuntWT.params_inferred_sigma(2); %[100]
w_br2_std = MCMC_6A1R_RuntWT.params_inferred_sigma(3); %[001]
w_br3_std = MCMC_6A1R_RuntWT.params_inferred_sigma(4); %[010]
...
mdl = @(TF, params, params_fixed) model_6A2R_HillModel_V3_compete_fixed_Kr_Bcd_RNAP_w_rp_params(params, TF, params_fixed);
model.modelfun = mdl;
...
%FigPath = 'S:\YangJoon\Dropbox\OpposingGradientsFigures\PipelineOutput\MCMC_HillV3\Competition\seq_MCMC_inference\6A2R_fixed_Kr\w_rr_and_w_ho';
...
%     params_MCMC = [1 1];
    ...
    output = model_6A2R_HillModel_V3_compete_fixed_Kr_Bcd_RNAP_w_rp_params(params_MCMC, TF, params_fixed);
    % Runt nulls
