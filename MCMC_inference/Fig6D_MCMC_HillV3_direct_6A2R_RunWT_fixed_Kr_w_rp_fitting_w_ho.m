function Fig6_C_MCMC_HillV3_direct_6A2R_RunWT_fixed_Kr_w_rp_fitting_w_ho
%% Description
...
%         end
    ...
    MCMC_6A2R_RuntWT(index).name = '6A2R_w_ho';
...
FigPath = 'S:\YangJoon\Dropbox\OpposingGradientsFigures\PipelineOutput\MCMC_HillV3\Direct\seq_MCMC_inference\6A2R_prediction_from_pt_estimates_fixed_Kr\fixed_K_r_w_rp_withCoop\higher_order_only';
