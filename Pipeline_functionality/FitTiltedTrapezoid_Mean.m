function FitTiltedTrapezoidAP_Mean(Construct)
...
while (cc~='x')
    ...
    elseif (ct~=0)&(cc=='v')
        ...
        Name = strcat('E:\YangJoon\LivemRNA\Data\Dropbox\Dropbox\OpposingGradient\Data_Processed\FittingMS2Traces\',Construct,'_InitialFit.mat');
