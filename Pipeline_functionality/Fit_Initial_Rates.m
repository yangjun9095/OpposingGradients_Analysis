function Fit_Initial_Rates(varargin)


%Paul, 05/30/2018
%This code is modified from FitMeanAPSymetric code, in order to have a fit
%of the initial rates only
...
DropboxFolder='E:\YangJoon\LivemRNA\Data\Dropbox\Dropbox\OpposingGradient';
DYNAMICS_RESULTS_PATH='E:\YangJoon\LivemRNA\Data\Dropbox\Dropbox\OpposingGradient';
MOVIE_DATABASE_PATH='E:\YangJoon\LivemRNA\Data\Dropbox\Dropbox\OpposingGradient';
    ...
    if APDivision(CurrentNC,i)
        ...
        if (sum(NParticlesAP(FrameWindow,i)>=MinParticles)>=MinTimePoints)
            ...
            if isempty(FitResults(i,CurrentNC-11).FitFrameRange)
                ...
                if CurrentNC==12
                    FitFrameRange=FitFrameRange((ElapsedTime(FitFrameRange)-ElapsedTime(APDivision(CurrentNC,i)))>3);
                    FitFrameRange=FitFrameRange((ElapsedTime(FitFrameRange)-ElapsedTime(APDivision(CurrentNC,i)))<7);
                elseif CurrentNC==13
                    
                    FitFrameRange=FitFrameRange((ElapsedTime(FitFrameRange)-ElapsedTime(APDivision(CurrentNC,i)))>3);
                    FitFrameRange=FitFrameRange((ElapsedTime(FitFrameRange)-ElapsedTime(APDivision(CurrentNC,i)))<7);
                elseif CurrentNC==14
                    FitFrameRange=FitFrameRange((ElapsedTime(FitFrameRange)-ElapsedTime(APDivision(CurrentNC,i)))<10);
                    FitFrameRange=FitFrameRange((ElapsedTime(FitFrameRange)-ElapsedTime(APDivision(CurrentNC,i)))>2);
                end
