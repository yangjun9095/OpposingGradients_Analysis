function PlotInputDynamics
% This script is for plotting the input dynamics of Bicoid and Runt over
% time and space.

%% Load datasets (Bcd and Runt)
BcdData = load('E:\YangJoon\LivemRNA\Data\Dropbox\Dropbox\OpposingGradient\Data_Processed\Bcd-Averaged.mat')
RuntData = load('E:\YangJoon\LivemRNA\Data\Dropbox\Dropbox\OpposingGradient\2018-08-19-RuntN-JB3-6-vasa-eGFP1\CompiledNuclei.mat')
