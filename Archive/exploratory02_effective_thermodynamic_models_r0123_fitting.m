...
Bcd_interp_nc14 = interp1(0:0.025:1,Bcd_averaged_nc14,0:0.01:1);
...
Runt = load('E:\YangJoon\LivemRNA\Data\Dropbox\OpposingGradient\OpposingGradients_ProcessedData\Runt-1min-200Hz-Male-Averaged.mat');
...
timeRange_nc14 = Runt.nc14:Runt.nc14+10; % for the first 10 minutes
...
%% Build an effective model for r0, then fit to determine the parameters
