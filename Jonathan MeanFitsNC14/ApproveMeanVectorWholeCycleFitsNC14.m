function ApproveMeanVectorWholeCycleFitsNC14(varargin)
...
if UseLocalMovieDatabase
    [SourcePath,FISHPath,DropboxFolder,MS2CodePath]=...
        DetermineLocalFolders(Prefix,'LocalMovieDatabase',LocalDropboxFolderString);
else
    [SourcePath,FISHPath,DropboxFolder,MS2CodePath]=...
...
%Load fit results                                
m = load([DropboxFolder,filesep,Prefix,'\MeanWholeCycleFitsNC14.mat']);
