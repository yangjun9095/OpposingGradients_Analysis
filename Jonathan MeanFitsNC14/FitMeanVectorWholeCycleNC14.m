...
% Edited by Yang Joon Kim on 06/02/2020 for incorporating the
% APDivision.mat
...
ncwindow = [0, 20]; %Time of fitting for nc14, [min]
...
% Define nc14 from the APDivisions for each APbin
nc14_adjusted = APDivision.APDivision(14,:);
...
for AP = 1:N_bins
    ...
    %Redefine the nc14 based on APDivisions.mat
    nc14 = nc14_adjusted(AP);
    if nc14~=0
