function [Rate] = model_6A2R_HillModel_V3_competition_HigherCoop(params,TF) 
...
Z = 1 + p + b.^6 + r1 + r2 +...
    b.^6.*(r1*w_br1 + r2*w_br2 + p*w_bp) + r1*p + r2*p + r1.*r2+...
    r1.*r2*p + b.^6*p*w_bp.*(r1*w_br1 + r2*w_br2) + b.^6.*r1.*r2*w_br1*w_br2*w_rr+...
    b.^6.*r1.*r2*p*w_bp*w_br1*w_br2*w_rr;

Z_p = p +  b.^6*p*w_bp + r1*p + r2*p +...
        r1.*r2*p + b.^6*p*w_bp.*(r1*w_br1 + r2*w_br2)+...
         b.^6.*r1.*r2*p*w_bp*w_br1*w_br2*w_rr;
