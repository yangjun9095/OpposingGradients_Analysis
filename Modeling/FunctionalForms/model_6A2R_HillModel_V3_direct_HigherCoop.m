function [Rate] = model_6A2R_HillModel_V3_direct_HigherCoop(params,TF) 
...
Z = 1 + p + b.^6 + r1 + r2 +...
    ...
    r1.*r2*p*w_rp1*w_rp2*w_ho + b.^6*p*w_bp.*(r1*w_rp1 + r2*w_rp2) + b.^6.*r1.*r2+...
    b.^6.*r1.*r2*p*w_bp*w_rp1*w_rp2*w_ho;

Z_p = p +  b.^6*p*w_bp + r1*p*w_rp1 + r2*p*w_rp2 +...
        r1.*r2*p*w_rp1*w_rp2*w_ho + b.^6*p*w_bp.*(r1*w_rp1 + r2*w_rp2)+...
         b.^6.*r1.*r2*p*w_bp*w_rp1*w_rp2*w_ho;
