function [Rate] = model_6A1R_HillModel_V3_quenching_fixedBcdRNAPparams(params, TF, params_fixed) 
...
P_bound = p*(1+b.^6*w_bp + r + b.^6.*r*w_bp*w_brp)./...
            (1 + p + b.^6 + r + b.^6.*r + b.^6*p*w_bp + r*p + b.^6.*r*p*w_bp*w_brp);
