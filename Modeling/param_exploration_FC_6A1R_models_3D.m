...
%% Calculate the boundary around the FC_pos1 and FC_pos2
...
%% plot the boundary in 2D (anterior and posterior)
hold on
...
%% 2) anterior and mid (20% and 30%)

%% Calculate the boundary of FC (20% and 30%)
bound_combination = boundary(FC_ant', FC_mid');

bound_compete = boundary(FC_ant_compete', FC_mid_compete');
bound_direct = boundary(FC_ant_direct', FC_mid_direct');
bound_quench = boundary(FC_ant_quench', FC_mid_quench');

%% plot the boundary in 2D (anterior and mid)
hold on
plot(FC_ant(bound_combination), FC_mid(bound_combination),'color', ColorChoice(1,:),'LineWidth',1.5);
plot(FC_ant_compete(bound_compete), FC_mid_compete(bound_compete), 'color', ColorChoice(2,:),'LineWidth',1.5)
plot(FC_ant_direct(bound_direct), FC_mid_direct(bound_direct), 'color', ColorChoice(4,:),'LineWidth',1.5)
plot(FC_ant_quench(bound_quench), FC_mid_quench(bound_quench), 'color', ColorChoice(6,:),'LineWidth',1.5)
...
errorbarxy(FC_001(APbin1), FC_001(APbin2),...
            FC_SEM_001(APbin1), FC_SEM_001(APbin2))
errorbarxy(FC_010(APbin1), FC_010(APbin2),...
            FC_SEM_010(APbin1), FC_SEM_010(APbin2))
errorbarxy(FC_100(APbin1), FC_100(APbin2),...
            FC_SEM_100(APbin1), FC_SEM_100(APbin2))
...
% save the plot
% saveas(gcf,[FigPath,filesep,'params_exploration_ant_mid','.pdf']);



%% 3) mid and post (30% and 40%)

%% Calculate the boundary of FC (20% and 30%)
bound_combination = boundary(FC_mid', FC_post');

bound_compete = boundary(FC_mid_compete', FC_post_compete');
bound_direct = boundary(FC_mid_direct', FC_post_direct');
bound_quench = boundary(FC_mid_quench', FC_post_quench');

%% plot the boundary in 2D (anterior and mid)
hold on
plot(FC_mid(bound_combination), FC_post(bound_combination),'color', ColorChoice(1,:),'LineWidth',1.5);
plot(FC_mid_compete(bound_compete), FC_post_compete(bound_compete), 'color', ColorChoice(2,:),'LineWidth',1.5)
plot(FC_mid_direct(bound_direct), FC_post_direct(bound_direct), 'color', ColorChoice(4,:),'LineWidth',1.5)
plot(FC_mid_quench(bound_quench), FC_post_quench(bound_quench), 'color', ColorChoice(6,:),'LineWidth',1.5)
...
errorbarxy(FC_001(APbin2), FC_001(APbin3),...
            FC_SEM_001(APbin2), FC_SEM_001(APbin3))
errorbarxy(FC_010(APbin2), FC_010(APbin3),...
            FC_SEM_010(APbin2), FC_SEM_010(APbin3))
errorbarxy(FC_100(APbin2), FC_100(16),...
            FC_SEM_100(APbin2), FC_SEM_100(16))
...
% Ellipsoid for the data points with error bars
ellipsoid(FC_001(APbin1), FC_001(APbin2), FC_001(APbin3), FC_SEM_001(APbin1), FC_SEM_001(APbin2), FC_SEM_001(APbin3),500)%,'o','MarkerFaceColor','k', 'MarkerEdgeColor', 'k')
ellipsoid(FC_010(APbin1), FC_010(APbin2), FC_010(APbin3), FC_SEM_010(APbin1), FC_SEM_010(APbin2), FC_SEM_010(APbin3),500)%, 'o','MarkerFaceColor','k', 'MarkerEdgeColor', 'k')
%ellipsoid(FC_100(APbin1), FC_100(APbin2), FC_100(16), FC_SEM_100(APbin1), FC_SEM_100(APbin2), FC_SEM_100(16))%,'o','MarkerFaceColor','k', 'MarkerEdgeColor', 'k')
