...
% interactions : Runt-Bcd (binding)

%% Scheme : Fitting to the FC, then recap the WT and Runt null initial rate profile
...
FC_model_fit = model_FC_6A1R_competition_V1(Bcd, Runt, params_fit);
...
Rate_null = compiledData{construct+1+8,9};
R_max = 700;%Rate_null(9); 

params_competition = [params_fit, R_max];
